package com.wei.spring_boot_practice.repository;
...
//        make sure that keyword is not null
        ...
        return productDB.stream().filter(p -> p.getName().contains(nameKeyword)).sorted(comparator).collect(Collectors.toList());
